...
class NER:
    ...
    def find_speaker(
        ...
        def analyze_following_text(text: str) -> str | None:
        ...
        def analyze_preceeding_text(text: str) -> str | None:
            doc = self.nlp(text.strip())
            if len(doc) > 1:
        ...
        if preceeding_name := analyze_preceeding_text(preceeding_text):
            return preceeding_name
        else:
            if following_name := analyze_following_text(following_text):
